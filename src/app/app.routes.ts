...
export const routes: Routes = [
  ...
  },
  {
    path: '', component: MainLayoutComponent, children: [
      ...
      { path: 'CheckOut', loadComponent: () => import('./pages/check-out/check-out.component').then((classes) => classes.CheckOutComponent), title: 'Check Out', canActivate: [authGuard, checkoutGuardGuard] },
      { path: 'Product-Details', loadComponent: () => import('./pages/product-details/product-details.component').then((classes) => classes.ProductDetailsComponent), title: 'ProductDetails', canActivate: [authGuard] },
